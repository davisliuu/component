...
//int sensor_write_register(ISP_DEV IspDev,int addr, char data)
//int my_sensor_write_register(ISP_DEV IspDev,int addr, char data)
{
    int ret;
...
printf("sensor_init 111111111111111  \n");  
    /* 1. sensor spi init */
    sensor_spi_init();
...
printf("sensor_init 2222222222222  \n"); 
    return ;
}

//void sensor_exit()
void sensor_exit(ISP_DEV IspDev)
{

printf("sensor_exit 111111111  \n"); 
    sensor_spi_exit();
...
int tmp = 0;
    ...
    tmp = sensor_read_register(0x4D1);
printf("****tmp 0x4D1 = 0x%x***\n",tmp);
    tmp = sensor_read_register(0x4D2);
printf("****tmp 0x4D2 = 0x%x***\n",tmp);
    tmp = sensor_read_register(0x4D4);
printf("****tmp 0x4D4 = 0x%x***\n",tmp);
    tmp = sensor_read_register(0x4D5);
printf("****tmp 0x4D5= 0x%x***\n",tmp);
    tmp = sensor_read_register(0x4D8);;
printf("****tmp 0x4D8 = 0x%x***\n",tmp);
    tmp = sensor_read_register(0x4D9);
printf("****tmp 0x4D9 = 0x%x***\n",tmp);
    tmp = sensor_read_register(0x4EC);
printf("****tmp 0x4EC = 0x%x***\n",tmp);
