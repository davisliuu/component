...
#define VIU_CHN_FISHEYE_LDC_SET_CTRL        _IOW(IOC_TYPE_VIU, IOC_NR_VIU_CHN_FISHEYE_LDC_ATTR_SET, VI_FISHEYE_LDC_ATTR_S) // the addr is passed implicitly
...
#define VIU_CHN_STITCHING_SET_CTRL        	_IOW(IOC_TYPE_VIU, IOC_NR_VIU_CHN_STITCHING_ATTR_SET, VI_FISHEYE_STITCHING_ATTR_S) // the addr is passed implicitly
#define VIU_CHN_STITCHING_GET_CTRL          _IOR(IOC_TYPE_VIU, IOC_NR_VIU_CHN_STITCHING_ATTR_GET, VI_STITCH_CORRECTION_ATTR_S)
#define VIU_CHN_SPREAD_SET_CTRL        		_IOW(IOC_TYPE_VIU, IOC_NR_VIU_CHN_SPREAD_ATTR_SET, VI_FISHEYE_SPREAD_ATTR_S) // the addr is passed implicitly
