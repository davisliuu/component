...
//dma
extern int osal_dmac_register_isr(unsigned int channel, void *pisr);
extern int osal_do_dma_llim2m_isp(unsigned int *source,
                                  unsigned int *dest,
                                  unsigned int *length,
                                  unsigned int num);
extern int osal_dmac_channel_free(unsigned int channel);
